...
var visboProjectVersionSchema = new mongoose.Schema({
	...
	customDblFields: [{str: {type: String, required: true}, dbl: {type: Number, required: false}}],
	customStringFields: [{strkey: {type: String, required: true}, strvalue: {type: String, required: false}}],
	customBoolFields: [{str: {type: String, required: true}, bool: {type: Boolean, required: false}}],
